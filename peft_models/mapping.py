...
from .tuners import LoraConfig, PrefixTuningConfig, PromptEncoderConfig, PromptTuningConfig, PromptRoutingConfig, PromptExpertConfig
...
PEFT_TYPE_TO_CONFIG_MAPPING = {
    ...
    "PROMPT_EXPERT": PromptExpertConfig,
}
